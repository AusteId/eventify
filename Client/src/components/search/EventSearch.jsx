                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="flex flex-wrap gap-2 mb-2">
                      <button
                        ...
                        className="px-3 py-1 text-xs bg-white border border-input-light rounded-full hover:bg-btn/8 text-body-medium"
                      >
                        Today
                      </button>
                      <button
                    ...
                    <div className="flex flex-col gap-2">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs text-body-medium">Start Date</span>
                      </div>
                      <input
                        type="date"
                    ...
                    <div className="flex flex-col gap-2">
                      <div className="flex items-center gap-2">
                        <IoCalendarOutline className="text-btn" />
                        <span className="text-xs text-body-medium">End Date</span>
                      </div>
                      <input
                        type="date"
