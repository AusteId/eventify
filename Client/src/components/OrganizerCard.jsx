...
const OrganizerCard = ({ image, title, rating, description }) => {
  return (
    <div className="">
      <div
      ...
      >
        <div className="flex w-full">
          <div className=" bg-gray-300 flex flex-row mb-2 w-12 h-12 rounded-full object-cover gap-3">
            ...
            <div className="gap-y-2 flex flex-col justify-start">
              <h3 className="whitespace-nowrap @apply text-gray-800 text-base not-italic font-bold leading-4 flex font-family: Inter;">
                {title}
              </h3>
        ...
        <p className="text-sm flex  text-gray-600/70 ">{description}</p>
      </div>
    </div>
  );
};
