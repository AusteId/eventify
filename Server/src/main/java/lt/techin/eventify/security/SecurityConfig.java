...
public class SecurityConfig {
  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    http.authorizeHttpRequests((authorize) -> authorize
                    ...
                    .requestMatchers(HttpMethod.GET, "/api/users/avatar").hasAnyAuthority("ADMIN", "USER", "BANNED")
                    .requestMatchers(HttpMethod.GET,"/api/users/{userId}/avatar").permitAll()
                    .requestMatchers(HttpMethod.GET,"/api/users/cities").permitAll()
                    .requestMatchers(HttpMethod.GET,"/api/about").permitAll()
                    .requestMatchers(HttpMethod.GET,"/api/about/{memberId}/picture").permitAll()
                    .requestMatchers(HttpMethod.POST,"/api/about").hasAuthority("ADMIN")
                    .requestMatchers(HttpMethod.PUT,"/api/about/{id}").hasAuthority("ADMIN")
                    .requestMatchers(HttpMethod.DELETE,"/api/about/{id}").hasAuthority("ADMIN")
...
//                        .hasAnyAuthority("ADMIN")
                    ...
                    .requestMatchers(HttpMethod.POST, "/api/users/{userId}/comments").hasAnyAuthority("ADMIN", "USER")
